...
function mainController($scope, $http) {    
    ...
    $scope.pesquisarContato = function() {   
        console.log('oiii: ', $scope.formContato);     
        $http.get('/api/contatos/' + $scope.formContato.pesquisar, $scope.formContato)
        .success( function(response){
            $scope.pesquisa = response;
